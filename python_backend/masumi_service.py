...
class MasumiService:
    ...
    def __init__(self):
        self.network_url = os.environ.get("MASUMI_NETWORK_URL", "https://masumi-testnet.io")
    ...
    async def update_reputation(
        ...
        alpha = 0.1
        agent.average_response_time = int(
    ...
    async def verify_service_credential(self, credential: Dict[str, Any]) -> bool:
        """
