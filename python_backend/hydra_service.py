...
class HydraService:
    ...
    def __init__(self):
        self.hydra_node_url = os.environ.get("HYDRA_NODE_URL",
                                             "http://localhost:4001")
    ...
    async def open_channel(self, participant_a: str, participant_b: str,
                           ...
                           initial_balance_b: float) -> Dict[str, Any]:
        """
        ...
        channel = HydraChannel(channel_id=channel_id,
    ...
    async def send_payment(self, channel_id: str, from_agent: str,
        ...
        channel.current_balance[to_agent] = channel.current_balance.get(
            to_agent, 0) + amount
    ...
    async def get_transaction_history(self,
        ...
        if channel_id:
            txs = [
                tx for tx in self._tx_history if tx["channel_id"] == channel_id
            ]
        else:
