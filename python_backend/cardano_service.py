...
class CardanoService:
    ...
    def __init__(self):
        self.network = os.environ.get("CARDANO_NETWORK", "testnet")  # testnet or mainnet
    ...
    async def register_agent_did(self, agent_id: str, agent_name: str, metadata: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def log_decision_on_chain(self, agent_id: str, decision: str, details: Dict[str, Any]) -> str:
        """
    ...
    async def settle_payment(self, from_agent: str, to_agent: str, amount: float) -> Dict[str, Any]:
        """
    ...
    async def create_smart_contract(self, contract_type: str, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def query_contract_state(self, contract_address: str) -> Dict[str, Any]:
        """
